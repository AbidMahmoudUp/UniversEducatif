...
public class MediaPlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        URL urlaudio = null;
        try {
            urlaudio = new URL(path);
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
        mediaVideo = new Media(urlaudio.toExternalForm());
        mpVideo = new MediaPlayer(mediaVideo);
        mvVideo.setMediaPlayer(mpVideo);
        mvVideo.setFitWidth(363);
        mvVideo.setFitHeight(256);
        /* String test="C:\\Users\\sboui\\Desktop\\PiDev\\mediaPlayer\\mediaPlayer\\src\\main\\resources\\com\\example\\img\\test1.mp4";
        try {
            Files.copy(Paths.get("C:\\Users\\sboui\\Desktop\\PiDev\\mediaPlayer\\mediaPlayer\\src\\main\\resources\\com\\example\\img\\test1.mp4"), Paths.get(test), StandardCopyOption.REPLACE_EXISTING);
        } catch (IOException e) {
            e.printStackTrace();
        }*/
        // extractAudioFromVideo("C:\\Users\\sboui\\Desktop\\PiDev\\mediaPlayer\\mediaPlayer\\src\\main\\resources\\com\\example\\img\\test1.mp4","C:\\Users\\sboui\\Desktop\\PiDev\\mediaPlayer\\mediaPlayer\\src\\main\\resources\\com\\example\\img\\test1.mp3");


        // Get the paths of the images and make them into images.
        Image imagePlay = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\play-btn.png").toURI().toString());
        // file:/D:/wittcode-2/java-2/send-video-client/src/resources/play-btn.png
        ivPlay = new ImageView(imagePlay);
        ivPlay.setFitWidth(24);
        ivPlay.setFitHeight(24);


        // Button stop image.
        Image imageStop = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\stop-btn.png").toURI().toString());
        ivPause = new ImageView(imageStop);
        ivPause.setFitHeight(24);
        ivPause.setFitWidth(24);

        // Restart button image.
        Image imageRestart = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\restart-btn.png").toURI().toString());
        ivRestart = new ImageView(imageRestart);
        ivRestart.setFitWidth(24);
        ivRestart.setFitHeight(24);

        // Volume (speaker) image.
        Image imageVol = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\volume.png").toURI().toString());
        ivVolume = new ImageView(imageVol);
        ivVolume.setFitWidth(24);
        ivVolume.setFitHeight(24);

        // Full screen image.
  /*      Image imageFull = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\fullscreen.png").toURI().toString());
        ivFullScreen = new ImageView(imageFull);
        ivFullScreen.setFitHeight(24);
        ivFullScreen.setFitWidth(24);*/

        // Muted speaker image.
        Image imageMute = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\mute.png").toURI().toString());
        ivMute = new ImageView(imageMute);
        ivMute.setFitWidth(24);
        ivMute.setFitHeight(24);

        // Exit full screen image.
        Image imageExit = new Image(new File("C:\\Users\\sboui\\Desktop\\JavaFxCoursTask\\CoursTask\\src\\main\\resources\\Images\\exitscreen.png").toURI().toString());
        ivExit = new ImageView(imageExit);
        ivExit.setFitHeight(24);
        ivExit.setFitWidth(24);
        ...
        StackPane.setAlignment(vboxParent, Pos.TOP_CENTER);

        // Replace the parent of mvVideo with the StackPane

        // Set padding around the edges of the VBox
        ...
        vboxParent.sceneProperty().addListener(new ChangeListener<Scene>() {
            ...
            public void changed(ObservableValue<? extends Scene> observableValue, Scene scene, Scene newScene) {
                if (scene == null && newScene != null) {
                    ...
                    mvVideo.fitHeightProperty().bind(newScene.heightProperty().subtract(hBoxControls.heightProperty().add(10)));
                }
            }
        });
