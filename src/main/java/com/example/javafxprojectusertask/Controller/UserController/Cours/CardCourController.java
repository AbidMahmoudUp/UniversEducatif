...
import com.example.javafxprojectusertask.Controller.CoachController.Cours.UpdateCourController;
...
public class CardCourController {
    ...
    @FXML
    void ouvrirPdf(MouseEvent event) {

        openFilee(pdfPath.getText());
    }
