...
import com.example.javafxprojectusertask.Interfaces.AuthCallback;
...
public abstract class OauthAuthentificator {
    ...
    public OauthAuthentificator (String clientID, String redirectUri, String clientSecret) {
